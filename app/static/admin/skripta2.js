    ...
    fetch('http://127.0.0.1:8080/api/users', {
        ...
        .then( 
            ...
            data.forEach( el => {
                ...
                <p><b>Admin: </b>${el.admin}</p>
                <p><b>Create date: </b>${el.createdAt}</p>
                </div>
            </div>`;
            });
        }).catch(err=>
            ...
            document.getElementById('deleteModalSubmit').addEventListener('click', e => {
                ...
                var url = new URL('http://127.0.0.1:8080/api/users/'+document.getElementById('inputID').value);
                console.log(url);
            ...
            document.getElementById('inputModalSubmit').addEventListener('click', e => {
                ...
                const data = {
                    ...
                    admin: document.getElementById('inputRole').value,
                ...
                fetch('http://127.0.0.1:8080/api/users', {
                    ...
                    .then( data => {
                        ...
                        <div class="card-body">
                          ...
                          <p><b>Admin: </b>${data.admin}</p>
                          <p><b>Create date: </b>${data.createdAt}</p>
                        </div>
                    </div>`;
                    });
                    // .catch(err => {
            ...
            document.getElementById('editSubmit').addEventListener('click', e => { 
                ...
                var url = new URL('http://127.0.0.1:8080/api/users/'+document.getElementById('inputEditID').value);
                console.log(url);
                ...
                fetch(url, {
                    ...
                    document.getElementById('inputEditRole').value=data.admin,
            ...
            document.getElementById('inputEditModalSubmit').addEventListener('click', e => {
                ...
                const data = {
                    ...
                    admin: document.getElementById('inputEditRole').value,
                ...
                document.getElementById('inputEditRole').value='';
                document.getElementById('inputEditEmail').value='';
                var url = new URL('http://127.0.0.1:8080/api/users/'+document.getElementById('inputEditID2').value);
                console.log(data);
                fetch(url, {
                    method: 'PUT',
                    headers: { 'Content-Type': 'application/json','Authorization': `Bearer ${token}` },
