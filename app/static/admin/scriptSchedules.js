function init() {
    ...
    fetch('http://127.0.0.1:8080/api/schedules',{headers:{'Authorization': `Bearer ${token}`}})
        .then( res => res.json())
        .then( 
            data => {
            ...
            data.forEach( el => {
                ...
                <div class="card" style="width: 18rem;">
                  <div class="card-body">
                    ...
                    <h6 class="card-subtitle mb-2 text-muted">Class ID: ${el.classId}</h6>
                  </div>
            `;
            });
        });
            ...
            document.getElementById('deleteModalSubmit').addEventListener('click', e => {
                ...
                var url = new URL('http://127.0.0.1:8080/api/schedules/'+document.getElementById('inputID').value);
                console.log(url);
            ...
            document.getElementById('inputModalSubmit').addEventListener('click', e => {
                ...
                const data = {
                    classId: document.getElementById('inputNumber').value,
                ...
                console.log(data);
                fetch('http://127.0.0.1:8080/api/schedules/', {
                    method: 'POST',
                    ...
                    .then( data => {
                        ...
                        <div class="card-body">
                          ...
                          <h6 class="card-subtitle mb-2 text-muted">Class ID: ${data.classId}</h6>
                        </div>
                    </div>`
                    document.location.reload();
                    ;
            ...
            document.getElementById('editSubmit').addEventListener('click', e => { 
                ...
                var url = new URL('http://127.0.0.1:8080/api/schedules/'+document.getElementById('inputEditID').value);
                ...
                fetch(url, {
                    ...
                    document.getElementById('inputEditNumber').value=data.classId,
             ...
             $(function() {
                $('#ed').click(function(){
                    ...
                    // Matching strategy 
                        const data = {
                            number: document.getElementById('inputEditName').value
                        };
                        document.getElementById('inputEditName').value='';
                        var url = new URL('http://127.0.0.1:8080/api/schedules/'+document.getElementById('inputEditID2').value);
                        console.log(data);
                        fetch(url, {
                            method: 'PUT',
                            headers: { 'Content-Type': 'application/json','Authorization': `Bearer ${token}` },
             ...
             document.getElementById('ed').addEventListener('click', e => {
                ...
                const data = {
                    classId: document.getElementById('inputEditNumber').value,
