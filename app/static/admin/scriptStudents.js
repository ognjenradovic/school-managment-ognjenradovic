    ...
    fetch('http://127.0.0.1:8080/api/students', {
        ...
        .then( 
            ...
            data.forEach( el => {
                ...
                <p><b>Date created: </b>${el.createdAt}</p>
                <p><b>Class ID: </b>${el.classId}</p>
                </div>
            </div>`;
            });
        }).catch(err=>
            ...
            document.getElementById('deleteModalSubmit').addEventListener('click', e => {
                ...
                var url = new URL('http://127.0.0.1:8080/api/students/'+document.getElementById('inputID').value);
                console.log(url);
            ...
            document.getElementById('inputModalSubmit').addEventListener('click', e => {
                ...
                const data = {
                    ...
                    classId: document.getElementById('inputClass').value,
            ...
            document.getElementById('editSubmit').addEventListener('click', e => { 
                ...
                var url = new URL('http://127.0.0.1:8080/api/students/'+document.getElementById('inputEditID').value);
                console.log(url);
                ...
                fetch(url, {
                    ...
                    document.getElementById('inputEditClass').value=data.classId
                    })
                    ;
            ...
            document.getElementById('inputEditModalSubmit').addEventListener('click', e => {
                ...
                const data = {
                    ...
                    classId: document.getElementById('inputEditClass').value
                };
                ...
                document.getElementById('inputEditClass').value='';
                var url = new URL('http://127.0.0.1:8080/api/students/'+document.getElementById('inputEditID2').value);
                console.log(data);
                fetch(url, {
                    method: 'PUT',
                    headers: { 'Content-Type': 'application/json','Authorization': `Bearer ${token}` },
